    ...
    $.ajax({
        ...
        success: function (e) {
            if (e == true) {
                ...
                $(".addPopUpIcon" + data.EmployeeID + "").html(`<button href="javascript:void(0)" class="faviadd btn btn-blue btn-sm" efid="${data.EmployeeID}" style="text-decoration:none;" data-target="#favnotPopUp" data-toggle="modal"> <i  class="la la-video-camera infoIcon"></i></button>`)
    ...
    $.ajax({
        ...
        success: function (e) {
            if (e == true) {
                ...
                $(".addPopUpIcon" + data.EmployeeID + "").html(`<button href="javascript:void(0)" class="faviadd btn btn-blue btn-sm" efid="${data.EmployeeID}" style="text-decoration:none;" data-target="#favPopUp" data-toggle="modal"> <i  class="la la-video-camera infoIcon"></i></button>`)
